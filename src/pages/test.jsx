      ...
      <div className="row pb-25">
        <div className="col-md-6">
          <div className="feature-item">
            ...
            <div className="content">
              <h5>
                <Link to="/tour-details">Tent Camping</Link>
              </h5>
              <p>
          ...
          <div className="feature-item">
            ...
            <div className="content">
              <h5>
                <Link to="/tour-details">Kayaking</Link>
              </h5>
              <p>
        ...
        <div className="col-md-6">
          <div className="feature-item mt-20">
            ...
            <div className="content">
              <h5>
                <Link to="/tour-details">Mountain Biking</Link>
              </h5>
              <p>
          ...
          <div className="feature-item">
            ...
            <div className="content">
              <h5>
                <Link to="/tour-details">Fishing &amp; Boat</Link>
              </h5>
              <p>
...
<div className="container-fluid">
  ...
  <div className="hotel-more-btn text-center mt-40">
    <Link to="/destination2" className="theme-btn style-four">
